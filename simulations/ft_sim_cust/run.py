...
def run():
    ...
    '''
    try:
        tst_price = fetch_asset_prices(['BTC', 'ETH', 'SOL', 'USDC', 'USDT'], initial_conditions['num_of_hrs'], sys_params['event'][0])
    except:
...
def postprocessing(df):
    ...
    for _, row in df.iterrows():
        ...
        timestep_data = {
            ...
            'contract_oi_btc_avg_price_long': pools[0]['contract_oi']['BTC']['avg_price_long'],
            'contract_oi_btc_avg_price_short': pools[0]['contract_oi']['BTC']['avg_price_short'],
            'contract_oi_eth_avg_price_long': pools[0]['contract_oi']['ETH']['avg_price_long'],
            'contract_oi_eth_avg_price_short': pools[0]['contract_oi']['ETH']['avg_price_short'],
            'contract_oi_sol_avg_price_long': pools[0]['contract_oi']['SOL']['avg_price_long'],
            'contract_oi_sol_avg_price_short': pools[0]['contract_oi']['SOL']['avg_price_short'],
            ...
            'contract_oi_btc_avg_collateral_price': pools[0]['contract_oi']['BTC']['avg_collateral_price'],
            'contract_oi_eth_avg_collateral_price': pools[0]['contract_oi']['ETH']['avg_collateral_price'],
            'contract_oi_sol_avg_collateral_price': pools[0]['contract_oi']['SOL']['avg_collateral_price'],
        }
