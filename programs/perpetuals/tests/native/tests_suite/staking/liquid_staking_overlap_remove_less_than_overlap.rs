...
pub async fn liquid_staking_overlap_remove_less_than_overlap() {
    ...
    // alice should get rewards from her first liquid staking
    {
        ...
        assert_eq!(balance_after - balance_before, 45_036_375);
    }
    ...
    // Remove LESS than the overlap staking
    // alice should get rewards for 1st staking
    {
        ...
        test_instructions::remove_liquid_stake(
            ...
            RemoveLiquidStakeParams {
                amount: utils::scale_f64(0.5, Cortex::LM_DECIMALS),
            },
            &cortex_stake_reward_mint,
            &test_setup.governance_realm_pda,
        )
        ...
        assert_eq!(balance_after - balance_before, 11_094);
    }
    ...
    // alice should get rewards from both stakings
    {
        ...
        assert_eq!(balance_after - balance_before, 15_277);
    }
}
