...
pub async fn test_bounty_no_rewards() {
        ...
        vec![
            utils::UserParam {
                ...
                token_balances: hashmap! {
                    ...
                    "eth" => utils::scale(2, USDC_DECIMALS),
                },
            },
            utils::UserParam {
                name: "martin",
    ...
    // tests bounties
    {
        ...
        let alice_stake_reward_token_account_before = test_setup
            ...
            .await
            .unwrap();
        let martin_stake_reward_token_account_before = test_setup
            .program_test_ctx
            .borrow_mut()
        ...
        // Martin: test_setup claim stake (stake account eligible for round, some for Alice only)
        ...
        let alice_stake_reward_token_account_after = test_setup
            ...
            .await
            .unwrap();
        let martin_stake_reward_token_account_after = test_setup
            .program_test_ctx
            .borrow_mut()
            .get_token_account(martin_stake_reward_token_account_address)
            .await
